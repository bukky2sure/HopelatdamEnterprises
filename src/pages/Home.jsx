    ...
    <Layout>
      ...
      <section className="bg-green-50 py-12 sm:py-16 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-10 md:mb-12 text-green-700">
            Our Products
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
            {galleryImages.map((img, idx) => (
              <div
                key={idx}
                className="overflow-hidden rounded-lg shadow h-52 sm:h-60 md:h-64"
              >
                <img
                  src={img}
                  alt={`Gallery ${idx + 1}`}
      ...
      <section className="bg-green-700 text-white py-12 sm:py-16 md:py-20 mb-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="mb-6 text-sm sm:text-base md:text-xl">
            Contact us today and secure the best wholesale deals.
          </p>

          <a
            href="/contact"
            className="inline-block bg-yellow-400 text-green-900 font-bold px-6 sm:px-8 py-2 sm:py-3 rounded-full hover:bg-yellow-300 transition"
          >
            Contact Us
          </a>
